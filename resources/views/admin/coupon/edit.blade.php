    ...
    <div class=" content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                <form class="js-validation" method="POST" action="{{route('admin_coupon_update')}}">
                    @csrf
                            ...
                            <div class="py-3">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control " id="code"
                                           name="code" placeholder="Kod" value="{{$coupon->code}}">
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="any" class="form-control " id="discount"
                                               name="discount" value="{{$coupon->discount}}" placeholder="29.99">
                                    </div>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <select name="status" class="form-control" id="status">
                                        ...
                                        @foreach($statuses as $status)
                                            <option
                                                {{$coupon->coupon_status->id == $status->id ? 'selected' : ''}} value="{{$status->id}}">{{$status->status}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-4 d-grid gap-2">
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Kaydet
                                    </button>
                                </div>
                            </div>
                        </div>
