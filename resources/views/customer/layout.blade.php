...
<head>
    <meta charset="utf-8">
    <title>Vizyonix</title>
    <meta name="description" content="Products that will change your life are waiting for you at Vizyonix.">
            ...
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{route('home')}}"><img
                                class="main__logo--img" src="{{asset('assets/img/logo/nav-log.png')}}" width="200px"
                                alt="logo-img"></a></h1>
                </div>
                        ...
                        <ul class="d-flex">
                            @foreach($categories as $category)
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="javascript:void(0)">{{$category->title}} </a>
                                </li>
                            @endforeach
                        </ul>
                    </nav>
                    ...
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            <a class="footer__widget--logo" href="index.html"><img src="assets/img/logo/nav-log.png"
                                                                                   alt="footer-logo"></a>
                            <p class="footer__widget--desc m-0">Products that will change your life are waiting for you
                                at Vizyonix.
                            </p>
