            ...
            <div class="container">
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n30">
                    <div class="col mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail display-block" href="shop.html"><img
                                    class="banner__items--thumbnail__img display-block" src="assets/img/banner/banner3.png"
                                    alt="banner-img">
                    ...
                    <div class="col mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail display-block" href="shop.html"><img
                                    class="banner__items--thumbnail__img display-block" src="assets/img/banner/banner4.png"
                                    alt="banner-img">
                                <div class="banner__two--content">
                                    <p class="banner__two--content__desc text-white">35 % Discount Offer</p>
                                    <h2 class="banner__two--content__title text-white">Fresh healthy food</h2>
                    ...
                    <div class="col mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail display-block" href="shop.html"><img
                                    class="banner__items--thumbnail__img display-block" src="assets/img/banner/banner5.png"
                                    alt="banner-img">
                                <div class="banner__two--content">
                                    <p class="banner__two--content__desc text-white">35 % Discount Offer</p>
                                    <h2 class="banner__two--content__title text-white">Fresh healthy food</h2>
                        ...
                        <div class="swiper-slide">
                            <div class="categories2__product--items text-center">
                                <div class="categories2__product--thumbnail">
                                    <a class="categories2__product--link display-block" href="shop.html"><img
                                            class="categories2__product--img display-block"
                                            src="assets/img/product/categories5.png" alt="categories-img"></a>
                                </div>
                                <div class="product__categories--content2">
                                    <h3 class="product__categories--content2__maintitle"><a href="shop.html">Vegan
                                            Broccoli</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items text-center">
                                <div class="categories2__product--thumbnail">
                                    <a class="categories2__product--link display-block" href="shop.html"><img
                                            class="categories2__product--img display-block"
                                            src="assets/img/product/categories6.png" alt="categories-img"></a>
                                </div>
                                <div class="product__categories--content2">
                                    <h3 class="product__categories--content2__maintitle"><a href="shop.html">Fresh
                                            Fruits</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items text-center">
                                <div class="categories2__product--thumbnail">
                                    <a class="categories2__product--link display-block" href="shop.html"><img
                                            class="categories2__product--img display-block"
                                            src="assets/img/product/categories7.png" alt="categories-img"></a>
                                </div>
                                <div class="product__categories--content2">
                                    <h3 class="product__categories--content2__maintitle"><a href="shop.html">Apple
                                            Juice </a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items text-center">
                                <div class="categories2__product--thumbnail">
                                    <a class="categories2__product--link display-block" href="shop.html"><img
                                            class="categories2__product--img display-block"
                                            src="assets/img/product/categories8.png" alt="categories-img"></a>
                                </div>
                                <div class="product__categories--content2">
                                    <h3 class="product__categories--content2__maintitle"><a href="shop.html">Fresh
                                            Berries</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items text-center">
                                <div class="categories2__product--thumbnail">
                                    <a class="categories2__product--link display-block" href="shop.html"><img
                                            class="categories2__product--img display-block"
                                            src="assets/img/product/categories9.png" alt="categories-img"></a>
                                </div>
                                <div class="product__categories--content2">
                                    <h3 class="product__categories--content2__maintitle"><a href="shop.html">Orange
                                            Juice</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items text-center">
                                <div class="categories2__product--thumbnail">
                                    <a class="categories2__product--link display-block" href="shop.html"><img
                                            class="categories2__product--img display-block"
                                            src="assets/img/product/categories10.png" alt="categories-img"></a>
                                </div>
                                <div class="product__categories--content2">
                                    <h3 class="product__categories--content2__maintitle"><a href="shop.html">Vegan
                                            Broccoli</a></h3>
                            ...
                            <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n28">
                                <div class="col md-28">
                                    <div class="product__items product__items2">
                                        ...
                                        <div class="product__items--content product__items2--content text-center">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">Vegetable-healthy</a>
                                            </h3>
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        ...
                                        <div class="product__items--content product__items2--content text-center">
                                            <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">Fresh-whole-fish</a>
                                            </h3>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        ...
                                        <div class="product__items--content product__items2--content text-center">
                                            <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">Chili-pepper</a>
                                            </h3>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        ...
                                        <div class="product__items--content product__items2--content text-center">
                                            <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">Green-surface</a>
                                            </h3>
                                            <div class="product__items--price">
                                                <span class="current__price">$38.00</span>
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        ...
                                        <div class="product__items--content product__items2--content text-center">
                                            <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">Red-tomato-isolated</a>
                                            </h3>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        ...
                                        <div class="product__items--content product__items2--content text-center">
                                            <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                            <h3 class="product__items--content__title h4"><a href="product-details.html">Raw-onions-surface</a>
                                            </h3>
                                            <div class="product__items--price">
                                ...
                                <div class="col-lg-6 col-md-8 col-12">
                                    <div class="product__banner position__relative">
                                        <a class="product__banner--thumbnail display-block" href="shop.html"><img
                                                class="product__banner--thumbnail__img display-block"
                                                src="assets/img/banner/product-banner.png" alt="banner-img">
                                            <div class="product__banner--content">
                                                <h3 class="product__banner--content__title text-white">Vagetable eggplant
                                                    <br>
                                                    100% fresh food </h3>
                                                <p class="product__banner--content__desc text-white"> We offer a hot deal
                                                    offer every festival </p>
                                                <span
                                                    class="btn  product__banner--content__btn text-white"> Shop Now </span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="product__items">
                                <div class="product__items--thumbnail">
                                    ...
                                    <div class="deals__product--countdown d-flex"
                        ...
                        <div class="swiper-slide">
                            <div class="product__items">
                                ...
                                <div class="product__items--content text-center">
                                    <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                    <h3 class="product__items--content__title h4"><a href="product-details.html">Papaya-green</a>
                                    </h3>
                                    <div class="product__items--price">
                ...
                <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-2">
                        ...
                        <div class="product__grid--wrapper">
                            ...
                            <div class="product__grid--inner">
                                <div class="product__grid--items d-flex align-items-center">
                                    <div class="product__grid--items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            ...
                                            <img class="product__grid--items__img product__secondary--img"
                                                 src="assets/img/product/small-product2.png" alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">Green-surface</a>
                                        </h3>
                                        <div class="product__items--price">
                                ...
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">Fresh-whole</a>
                                        </h3>
                                        <div class="product__items--price">
                                ...
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">Chili-pepper</a>
                                        </h3>
                                        <div class="product__items--price">
                        ...
                        <div class="product__grid--wrapper">
                            ...
                            <div class="product__grid--inner">
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">Red-tomato</a>
                                        </h3>
                                        <div class="product__items--price">
                                ...
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">Papaya-green</a>
                                        </h3>
                                        <div class="product__items--price">
                                ...
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">onions-surface</a>
                                        </h3>
                                        <div class="product__items--price">
                                            <span class="current__price text-black">$48.00</span>
                                        </div>
                        ...
                        <div class="product__grid--wrapper">
                            ...
                            <div class="product__grid--inner">
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">Raw-onions</a>
                                        </h3>
                                        <div class="product__items--price">
                                ...
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="product-details.html">Whole-fish</a>
                                        </h3>
                                        <div class="product__items--price">
                    ...
                    <div class="col custom-col">
                        <div class="product__banner2 position__relative">
                            <a class="product__banner2--thumbnail display-block" href="shop.html"><img
                                    class="product__banner2--thumbnail__img display-block"
                                    src="assets/img/banner/product-banner2.png" alt="banner-img">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                ...
                                <div class="blog__items--content">
                                    ...
                                    <h3 class="blog__items--title"><a href="blog-details.html">Aypi Non Habent Claritatemnon
                                            Insitam</a></h3>
                                    <p class="blog__items--desc">It is a long established fact that a reader will be by the
                                        readable content of a page when looking at its layout. The point of using </p>
                                    <a class="blog__items--readmore" href="blog-details.html">Read more
                                        <svg class="blog__items--readmore__icon" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                ...
                                <div class="blog__items--content">
                                    ...
                                    <h3 class="blog__items--title"><a href="blog-details.html">Lorem ipsum dolor sit amet
                                            are consecte.</a></h3>
                                    <p class="blog__items--desc">It is a long established fact that a reader will be by the
                                        readable content of a page when looking at its layout. The point of using </p>
                                    <a class="blog__items--readmore" href="blog-details.html">Read more
